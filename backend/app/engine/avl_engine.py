...
class AVLEngine:
    ...
    @classmethod
    def avl_deletion_pipeline(cls, values: List[int], target_id: str) -> List[TreeStep]:
        ...
        search_path = []
        def get_layout():
            return cls._get_layout(root_container[0])
        ...
        def delete_node(node: Optional[AVLTreeNode], id_to_find: str, val_to_search: int) -> Optional[AVLTreeNode]:
        ...
        root_container[0] = delete_node(root_container[0], target_id, target_value)
