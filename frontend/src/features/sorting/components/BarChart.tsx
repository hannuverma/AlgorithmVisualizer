...
export const BarChart: React.FC = () => {
  ...
  return (
    <div className="w-full bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xl">
      {/* Bars Container */}
      <div className="h-64 flex items-end justify-center gap-1 sm:gap-2 px-2 border-b border-slate-800 pb-2">
        {currentStep.array.map((value, idx) => {
          ...
          if (isSwapped) {
            barColor = 'bg-rose-500 shadow-[0_0_15px_rgba(244,63,94,0.6)] scale-105'; // Active mutation
          } else if (isHighlighted) {
            barColor = 'bg-amber-400 shadow-[0_0_12px_rgba(251,191,36,0.5)]'; // Selection/Comparison
          }
